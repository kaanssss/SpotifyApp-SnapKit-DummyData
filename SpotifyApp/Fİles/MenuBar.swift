...
class MenuBar: UIView {
    ...
    private func layout() {
        ...
        artistsButton.snp.makeConstraints { make in
            make.top.equalToSuperview()
            make.leading.equalTo(playlistsButton.snp.trailing).offset(buttonSpace)
        }
        
        albumsButton.snp.makeConstraints { make in
            make.top.equalToSuperview()
            make.leading.equalTo(artistsButton.snp.trailing).offset(buttonSpace)
        }
